  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <br>
        <div class="form-group form-inline justify-content-center" style="font-family:Adobe Garamond Pro Bold">
          <label class="col-sm-auto"><h5>Patient Id: </h5></label><input type="text" class="form-control col-sm-3" name="pid" id="pid" required value="<?php echo $_SESSION["uid"]; ?> "  readonly> 
    </div>
        <br>
       <div class="container">
           <div class="row">
