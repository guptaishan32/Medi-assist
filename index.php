...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
   ...
   <div class="container-fluid">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2 d-sm-none d-none d-lg-block">
                <div class="d-flex btn-sm">
                    <div> <button class="btn btn-primary" href="#" role="button" data-toggle="modal" data-target="#signup">SIGNUP</button></div>&nbsp;
                    <div> <button class="btn btn-success" href="#" role="button" data-toggle="modal" data-target="#login">LOGIN</button></div>
                </div>
            </div>
            <div class="col-lg-6 d-sm-none d-none d-lg-block d-lg-inline-flex justify-content-center" id="headernav" style="margin-top:10px">
        ...
        <!--Navbar-->
            <div class="col-lg-4 d-sm-none d-none d-lg-block">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <!--Desktop Carousel-->
            <div style="margin-top:120px" class="d-none d-sm-none d-lg-block">
          ...
          <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
            ...
            <span class="sr-only">Next</span>
              ...
              <!--Mobile Carousel-->
            <div style="margin-top:105px" class="d-sm-none d-block">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          <ol class="carousel-indicators">
            <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
            <li data-target="#carouselExampleIndicators" data-slide-to="1"></li>
          ...
          <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
            ...
            <span class="sr-only">Next</span>
             ...
             <!--tablet Carousel-->
            <div style="margin-top:105px" class="d-lg-none d-sm-block d-none">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          <ol class="carousel-indicators">
            <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
            <li data-target="#carouselExampleIndicators" data-slide-to="1"></li>
       ...
       <div class="container-fluid">
           <div class="row">
               <div class="col-12">
                   <center><div id="infolines">Our services</div></center>
               </div>
           </div>
       </div>
    </div>
        ...
        <div class="container">
          ...
          <div class="card" id="card">
            ...
            <div class="card-body" id="cardbody">
                <center><div class="card-text" id="cardtitle">Sugar Record</div></center>
          ...
          <div class="card" id="card">
            ...
            <div class="card-body" id="cardbody">
                <center><div class="card-text" id="cardtitle">BP REcord</div></center>
        ...
        <!--Card Row 2-->
         <div class="container">
          ...
          <div class="card" id="card">
            ...
            <div class="card-body" id="cardbody">
                <center><div class="card-text" id="cardtitle">Appointments</div></center>
          ...
          <div class="card" id="card">
            ...
            <div class="card-body" id="cardbody">
                <center><div class="card-text" id="cardtitle">Doctor Search</div></center>
       ...
       <div class="container-fluid">
           <div class="row">
               <div class="col-12">
                   <center><div id="infolines">About US</div></center>
               </div>
           </div>
       </div>
    </div>
          ...
          <div class="container-fluid">
              <div class="row">
                <div class="col-md-12 col-lg-6 col-12">
                  <center><div id="tableinfolines">Developed By</div></center>
                  <br>
                  <div class="row">
                   ...
                   <table class="table table-borderless ">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="d-block d-md-none font-weight-bold" style="font-size:12px">GUPTAISHAN32@GMAIL.COM</td>
                        </tr>
                        <tr>
                        <tr>
                ...
                <div class="col-md-12 col-lg-6 col-12">
                  <center><div id="tableinfolines">Under Guidance</div></center>
                <br>
                <div class="row">
                <div class="col-12 col-md-12 col-lg-3">
           ...
           <div class="row">
               <div class="col-12">
                   <center><div id="infolines">Contact Us</div></center>
               </div>
           </div>
       </div>
          <br>
  ...
  <div class="row">
    <div class="col-lg-6 col-md-12 col-sm-6 col-12">
     ...
     <div class="col-12 col-lg-6 col-md-12 d-none d-md-block">
       ...
       <table class="table">
           <td>
               <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13791.522932618522!2d74.9523281!3d30.2119513!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x4a0d6293513f98ce!2sBanglore+Computer+Education+(C+C%2B%2B+Android+J2EE+PHP+Python+AngularJs+Spring+Java+Training+Institute)!5e0!3m2!1sen!2sin!4v1531409909358" width="220" height="180" frameborder="0" style="border:1" allowfullscreen></iframe>
           </td>
       </table>
        </div>
       ...
       <div class="col-lg-6 col-md-12 col-sm-6 col-12">
     <center><div id="tableinfolines">Follow Us</div></center>
     <div class="col-12 col-lg-5 col-md-12 d-none d-md-block">
       <table class="table justify-content-center">
           <td>
               <div class="fb-page" data-href="https://www.facebook.com/Mediassist-411424336013834/?modal=admin_todo_tour" data-tabs="timeline" data-width="500" data-height="180" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/Mediassist-411424336013834/?modal=admin_todo_tour" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/Mediassist-411424336013834/?modal=admin_todo_tour">Mediassist</a></blockquote></div>
           </td>
         </table>
           </div>
          <div class="col-12 d-block d-sm-none ">
       <table class="table">
           <td>
               <div class="fb-page" data-href="https://www.facebook.com/Mediassist-411424336013834/?modal=admin_todo_tour" data-tabs="timeline" data-width="220" data-height="180" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/Mediassist-411424336013834/?modal=admin_todo_tour" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/Mediassist-411424336013834/?modal=admin_todo_tour">Mediassist</a></blockquote></div>
           </td>
              </table>
           </div>
           <div class="col-12 d-block d-sm-none ">
       ...
       <div class="container-fluid">
           <div class="row">
               <div class="col-12">
                   <center><div id="copyright">&copy;medi-assist 2018</div></center>
               </div>
           </div>
       </div>
    <!--Doctor Search-->
                    ...
                    <div class="col-md-12" >
                     <div class="card" id="card1">
                      ...
                      <div class="card-body" id="searchbody">
                       <center>
                           <div class="card-title"><h5>NAME: {{record.name}}</h5></div>
                ...
                <form id="sfrm" action="index-submitpage.php" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Email Id: </label><span class="text-info font-weight-bold" id="res"><img src="pics/loading-ttcredesign.gif" id="waitt" width="20px" height="20px"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group form-check-password ">
                                ...
                                <!--<div><i class="fas fa-info fa-xs font-italic" style:background-color="blue"></i>:</div>&nbsp;&nbsp;-->
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" name="smobile" id="smobile" type="smobile" placeholder="78xxxxxxxx" required pattern="[7-9]{1}[0-9]{9}" maxlength="10" autocomplete="off">
                            </div>
                            <!--buttons-->
                            <div class="form-row">
